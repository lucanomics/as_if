...
export function MyPracticePage() {
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="rounded-lg border border-[--color-line] bg-[--color-card] p-4 text-sm text-[--color-text-secondary]">
        Records are stored locally in your browser. They are not synced or reviewed by As If.
      </div>

      {sortedRecords.length === 0 ? (
        <div className="rounded-lg border border-[--color-line] bg-[--color-card] p-5 space-y-2">
